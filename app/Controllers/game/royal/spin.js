					...
					HU.findOne({game:'roy', type:bet, red:red}, {}, function(err2, dataHu){
						...
						.then(result => {
							...
							if (red) {
								...
								client.red({royal:{status:1, cel:[cel1, cel2, cel3, cel4, cel5], line_win:result, win:bet_win, free:client.RoyAl.free, isFree:isFree, isBonus:client.RoyAl.bonusX, isNoHu:nohu, isBigWin:isBigWin}, user:{red:user.red-tongCuoc+bet_win}});
