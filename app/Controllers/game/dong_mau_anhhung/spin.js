				...
				if (!user || client.DongMauAnhhung.free === 0 && user.red < tongCuoc) {
					...
					HU.findOne({game:'dongmauanhhung', type:bet}, {}, function(err2, dataHu){
						...
						.then(result => {
							...
							client.red({DongMauAnhhung:{status:1, cel:[cel1, cel2, cel3, cel4, cel5], line_win:result, win:bet_win, free:client.DongMauAnhhung.free, isFree:isFree, isBonus:!!client.DongMauAnhhung.bonusX, isNoHu:nohu, isBigWin:isBigWin}, user:{red:user.red-tongCuoc+bet_win}});
