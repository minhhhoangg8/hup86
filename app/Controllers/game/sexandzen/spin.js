					...
					HU.findOne({game:'sexandzen', type:bet}, {}, function(err2, dataHu){
						...
						*/
						...
						.then(result => {
							...
							client.red({sexandzen:{status:1, cel:[cel1, cel2, cel3, cel4, cel5], line_win:result, win:bet_win, free:client.Sexandzen.free, isFree:isFree, isBonus:!!client.Sexandzen.bonusX, isNoHu:nohu, isBigWin:isBigWin}, user:{red:user.red-tongCuoc+bet_win}});
