				...
				if (!user || client.VuongQuocRed.free === 0 && user.red < tongCuoc) {
					...
					HU.findOne({game:'vuongquocred', type:bet}, {}, function(err2, dataHu){
						...
						.then(result => {
							...
							client.red({VuongQuocRed:{status:1, cel:[cel1, cel2, cel3, cel4, cel5], line_win:result, win:bet_win, free:client.VuongQuocRed.free, isFree:isFree, isBonus:!!client.VuongQuocRed.bonusX, isNoHu:nohu, isBigWin:isBigWin}, user:{red:user.red-tongCuoc+bet_win}});
