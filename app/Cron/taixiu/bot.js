...
let random1 = function(){
	let a = (Math.random()*50)>>0;
	if (a == 34) {
		// 34
		return (Math.floor(Math.random()*(20-20+1))+20)*100000;
	}else if (a >= 32 && a < 34) {
		// 32 33
		...
		// 15 16 17 18 19 20
		return (Math.floor(Math.random()*(10-20+1))+20)*100000;
	}else if (a >= 4 && a < 8) {
		// 8 9 10 11 12 13 14
		return (Math.floor(Math.random()*(50-20+1))+20)*100000;
	}else if (a >= 35 && a < 41) {
		// 8 9 10 11 12 13 14
		return (Math.floor(Math.random()*(30-20+1))+10)*100000;
	}else{
		// 0 1 2 3 4 5 6 7
		return (Math.floor(Math.random()*(30-20+1))+20)*100000;
	}
...
let tx = function(bot, io){
	...
	if (select) {
		...
		io.taixiu.taixiu.red_player_tai += 6;
	}else{
		io.taixiu.taixiu.red_xiu        += cuoc;
		io.taixiu.taixiu.red_player_xiu += 6;
	}
	if(cuoc > 1){
