...
*/
let random = function(){
	let a = (Math.random()*23)>>0;
	if (a == 23) {
		// 34
		return (Math.floor(Math.random()*(20-3+1))+3)*5000;
	}else if (a >= 32 && a < 34) {
		// 32 33
		return (Math.floor(Math.random()*(20-5+1))+5)*1000;
	}else if (a >= 30 && a < 32) {
		// 30 31 32
		return (Math.floor(Math.random()*(20-10+1))+10)*5000;
	}else if (a >= 26 && a < 30) {
		// 26 27 28 29
		return (Math.floor(Math.random()*(100-10+1))+10)*5000;
	}else if (a >= 21 && a < 26) {
		// 21 22 23 24 25
		return (Math.floor(Math.random()*(200-10+1))+10)*5000;
	}else if (a >= 15 && a < 21) {
		// 15 16 17 18 19 20
		return (Math.floor(Math.random()*(10-5+1))+5)*5000;
	}else if (a >= 8 && a < 15) {
		// 8 9 10 11 12 13 14
		return (Math.floor(Math.random()*(7-2+1))+2)*5000;
	}else{
		// 0 1 2 3 4 5 6 7
...
module.exports = function(bot, io){
	...
	let create = {uid:bot.id, bot:false, name:bot.name, phien:io.BauCua_phien, time:new Date()};
